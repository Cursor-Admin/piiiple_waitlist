		...
		<div className='w-full max-w-7xl mx-auto px-6 md:px-0'>
			...
			<motion.div
				...
				<div className='flex w-full items-center text-center'>
					<motion.p
						className='text-white text-xl sm:text-4xl lg:text-5xl font-semibold leading-tight lg:leading-tight max-w-4xl mx-auto text-center'
						initial={{ opacity: 0, y: 20 }}
						whileInView={{ opacity: 1, y: 0 }}
						transition={{ delay: 0.2, duration: 0.6 }}>
						A new way to <span className='italic font-messina'>onboard</span>{" "}
						third-party business operations and{" "}
						<span className='italic font-messina'> integrations</span>
					</motion.p>
				</div>
				<motion.div
					className='mt-10'
			...
			<motion.div
				...
				<motion.div
					...
					<span className='italic font-messina text-[20px]'>
						For Actual People
					</span>
					<p className='font-[600]'>hello@piiipleai.com</p>
				</motion.div>
